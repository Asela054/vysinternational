...
class Productinfo extends CI_Model{
    ...
    public function getItemCostReport() {
        ...
        <div class="form-row">
            <div class="col">
                ...
                <input type="hidden" name="productid" id="productid" class="form-control form-control-sm" value="'.$respond->row(0)->idtbl_product.'" readonly>
            </div>
            <div class="col">
    ...
    public function Productconditioninsertupdate(){
        ...
        $userID = $_SESSION['userid'];
        $product_id = $this->input->post('recordID'); // Product ID from the form
        ...
        $excludeFields = ['recordID', 'productname', 'productcode', 'grnqty', 'itemdesc'];
        ...
        if ($this->db->trans_status() === TRUE) {
            ...
            $actionObj->icon = 'fas fa-save';
            $actionObj->title = '';
            $actionObj->message = 'Quality conditions saved successfully';
            $actionObj->url = '';
            $actionObj->target = '_blank';
            $actionObj->type = 'success';
            $actionObj->status = 1;
            ...
            $actionObj->icon = 'fas fa-warning';
            $actionObj->title = '';
            $actionObj->message = 'Error saving quality conditions';
            $actionObj->url = '';
            $actionObj->target = '_blank';
            $actionObj->type = 'danger';
            $actionObj->status = 0;
