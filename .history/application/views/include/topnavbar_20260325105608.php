...
<a class="navbar-brand d-none d-sm-block" href="#"><?php echo $_SESSION['company'] ?></a><button class="btn btn-icon btn-transparent-dark order-1 m-2 order-lg-0 mr-lg-2" id="sidebarToggle" href="#"><i data-feather="menu"></i></button>
