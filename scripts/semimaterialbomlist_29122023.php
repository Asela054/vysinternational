...
$columns = array(
	...
	array( 'db' => '`uc`.`title`', 'dt' => 'title', 'field' => 'title' ),
	array( 'db' => '`uc`.`idtbl_semi_bom_info`', 'dt' => 'idtbl_semi_bom_info', 'field' => 'idtbl_semi_bom_info' ),
...
LEFT JOIN `tbl_semi_bom_info` AS `uc` ON (`uc`.`idtbl_semi_bom_info` = `u`.`tbl_semi_bom_info_idtbl_semi_bom_info`)";

$extraWhere = "`u`.`status` IN (1, 2)";

$groupBy ="`u`.`tbl_semi_bom_info_idtbl_semi_bom_info`";
