...
$columns = array(
	...
	array( 'db' => '`uc`.`qty`', 'dt' => 'qty', 'field' => 'qty' ),
	array( 'db' => '`uc`.`damageqty`', 'dt' => 'damageqty', 'field' => 'damageqty' ),
	array( 'db' => '`ud`.`startdatetime`', 'dt' => 'startdatetime', 'field' => 'startdatetime' ),
	array( 'db' => '`ud`.`enddatetime`', 'dt' => 'enddatetime', 'field' => 'enddatetime' ),
...
$joinQuery = "FROM `tbl_semi_production` AS `u` 
