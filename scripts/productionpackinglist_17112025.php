...
$extraWhere = "`u`.`status` IN (1, 2) AND (`u`.`materialissue` = 1 OR `u`.`partialissued` = 1) AND `ub`.`tbl_company_idtbl_company`='$companyid' AND `ub`.`tbl_company_branch_idtbl_company_branch`='$branchid'";
