...
$joinQuery = "FROM `tbl_customer_porder` AS `u` LEFT JOIN `tbl_customer` AS `ua` ON (`ua`.`idtbl_customer` = `u`.`tbl_customer_idtbl_customer`) LEFT JOIN `tbl_order_type` AS `ub` ON (`ub`.`idtbl_order_type` = `u`.`tbl_order_type_idtbl_order_type`)";
