										...
										<div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
											...
											<div class="card-body border rounded"
												...
												<div class="row row-cols-1 row-cols-md-4">
													...
													<div class="col mb-4 categorydiv"
														id="<?php echo $rowmaterial->idtbl_material_code ?>">
														<div
														...
														<table class="table table-bordered table-striped table-sm"
															...
															<thead>
																<tr>
																	...
																	<th class="text-small">RETAIL / WHOLE SALE PRICE
																	</th>
					...
					<div class="card-body">
						<div class="row">
							<div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 text-right">
								<button id="paymentbtn" class="btn btn-success btn-sm"><i
	...
	<div class="modal-dialog modal-dialog-centered modal-sm">
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
					<div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
						<button id="btnretailsale" type="button" class="btn btn-primary btn-sm w-100 mb-3"><i
								class="fas fa-cash-register fa-3x mr-2"></i>
							<h1 class="font-weight-normal mt-2 text-light">RETAIL SALE</h1>
						</button>
					</div>
					<div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
						<button id="btnwholesale" type="button" class="btn btn-danger btn-sm w-100"><i
								class="fas fa-cash-register fa-3x mr-2"></i>
...
<script type="text/javascript">
    ...
    function productlistoption(){
        $("#tableproductpricelist").delegate("tr.pointer", "click", function(){
            ...
            var sale = $(this).children("td:eq(3)").text();
