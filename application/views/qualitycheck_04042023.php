...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#dataTable').DataTable({
            ...
            "columns": [
                ...
                },
                {
                    ...
                    "data": null,
                    "render": function(data, type, full) {
                        if(full['qualitycheck']==0){return '<i class="fas fa-times text-danger mr-2"></i>Pending';}
                        else{return '<i class="fas fa-check text-success mr-2"></i>Checked';}
                    }
                },
                {
                    "targets": -1,
        ...
        $('#dataTable tbody').on('click', '.btncheck', function () {
        	...
        	var applyqualityButton = $('#btnapplyquality');
        	...
        	$.ajax({
        		...
        		success: function (result) {
        			...
        			// if ($('#materialinfo').val() == "") {
        			// 	applyqualityButton.prop('disabled', true);
        			// } else {
        			// 	applyqualityButton.prop('disabled', false);
        			// }
        		}
        	});
        });
