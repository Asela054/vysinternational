...
$(function () {
    ...
    $(document).ready(function () {
        ...
        $('#invoicetable').DataTable({
            ...
            "serverSide": true,
            ajax: {
                url: "scripts/returninvoicelist.php",
                    ...
                    },
                    {
                        ...
                        "render": function(data, type, full) {
                            var button = '';
                                ...
                                button+='<button class="btn btn-secondary btn-sm btnviewList mr-1 ';if(editcheck!=1){button+='d-none';}button+='" id="'+full['idtbl_invoice_return']+'"><i class="fas fa-list"></i></button>';
	...
	$.ajax({
		...
		url: '<?php echo base_url() ?>Returninvoiceview/Getinvoicedetails',
