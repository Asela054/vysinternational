            ...
            "columns": [
                ...
                },
                {
                    ...
                    "render": function(data, type, full) {
                        ...
                        button += '<a href="<?php echo base_url() ?>Customerporder/printreport/' + full['idtbl_customer_porder'] + '" target="_blank" class="btn btn-secondary btn-sm mr-1"><i class="fas fa-print"></i></a>';
