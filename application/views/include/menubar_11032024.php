...
<nav class="sidenav shadow-right sidenav-light">
    <div class="sidenav-menu">
        <div class="nav accordion" id="accordionSidenav">
            ...
            <?php } if(menucheck($menuprivilegearray, 40)==1  | menucheck($menuprivilegearray, 51)==1 | menucheck($menuprivilegearray, 56)==1 | menucheck($menuprivilegearray, 66)==1){ ?>
            ...
            <div class="collapse <?php if($controllermenu=="Directsale" | $controllermenu=="Directinvoice" | $controllermenu=="Invoiceview" | $controllermenu=="Returninvoice"){echo 'show';} ?>"
