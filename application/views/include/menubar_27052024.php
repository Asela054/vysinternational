...
<nav class="sidenav shadow-right sidenav-light">
    <div class="sidenav-menu">
        <div class="nav accordion" id="accordionSidenav">
            ...
            <?php } if(menucheck($menuprivilegearray, 4)==1 | menucheck($menuprivilegearray, 5)==1 | menucheck($menuprivilegearray, 6)==1 | menucheck($menuprivilegearray, 7)==1 | menucheck($menuprivilegearray, 8)==1 | menucheck($menuprivilegearray, 9)==1 | menucheck($menuprivilegearray, 10)==1 | menucheck($menuprivilegearray, 11)==1){ ?>
            ...
            <div class="collapse <?php if($controllermenu=="Materialcategory" | $controllermenu=="Brand" | $controllermenu=="Form" | $controllermenu=="Grade" | $controllermenu=="Size" | $controllermenu=="Side" | $controllermenu=="Unittype" | $controllermenu=="Unit"){echo 'show';} ?>" id="collapseMaster" data-parent="#accordionSidenav">
                <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPages">
                    ...
                    <a class="nav-link p-0 px-3 py-1 text-dark" href="<?php echo base_url().'Brand'; ?>">Brand</a>
                    <?php } if(menucheck($menuprivilegearray, 6)==1){ ?>
                    <a class="nav-link p-0 px-3 py-1 text-dark" href="<?php echo base_url().'Form'; ?>">Form</a>
                    <?php } if(menucheck($menuprivilegearray, 7)==1){ ?>
                    <a class="nav-link p-0 px-3 py-1 text-dark" href="<?php echo base_url().'Grade'; ?>">Grade</a>
                    <?php } if(menucheck($menuprivilegearray, 8)==1){ ?>
                    <a class="nav-link p-0 px-3 py-1 text-dark" href="<?php echo base_url().'Size'; ?>">Size</a>
                    <?php } if(menucheck($menuprivilegearray, 9)==1){ ?>
                    <a class="nav-link p-0 px-3 py-1 text-dark" href="<?php echo base_url().'Side'; ?>">Side</a>
                    <?php } if(menucheck($menuprivilegearray, 10)==1){ ?>
                    <a class="nav-link p-0 px-3 py-1 text-dark" href="<?php echo base_url().'Unittype'; ?>">Unit Type</a>
                    <?php } if(menucheck($menuprivilegearray, 11)==1){ ?>
                    <a class="nav-link p-0 px-3 py-1 text-dark" href="<?php echo base_url().'Unit'; ?>">Unit</a>
                    <?php } ?>
                </nav>
            </div>
            <?php } if(menucheck($menuprivilegearray, 12)==1 | menucheck($menuprivilegearray, 13)==1){ ?>
            ...
            <div class="collapse <?php if($controllermenu=="Materialcode" | $controllermenu=="Materialdetail"){echo 'show';} ?>" id="collapseMaterialinfo" data-parent="#accordionSidenav">
                <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPages">
            ...
            <?php } if(menucheck($menuprivilegearray, 53)==1 | menucheck($menuprivilegearray, 54)==1 | menucheck($menuprivilegearray, 60)==1 | menucheck($menuprivilegearray, 64)==1){ ?>
            ...
            <div class="collapse <?php if($controllermenu=="Semibom" | $controllermenu=="Semiproduction" | $controllermenu=="Semiproductionquality" | $functionmenu=="Semiproductionprocess"){echo 'show';} ?>" id="collapseSemi" data-parent="#accordionSidenav">
                <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPages">
            ...
            <?php } if(menucheck($menuprivilegearray, 40)==1  | menucheck($menuprivilegearray, 51)==1 | menucheck($menuprivilegearray, 56)==1 | menucheck($menuprivilegearray, 66)==1| menucheck($menuprivilegearray, 68)==1){ ?>
            ...
            <div class="collapse <?php if($controllermenu=="Directsale" | $controllermenu=="Directinvoice" | $controllermenu=="Invoiceview" | $controllermenu=="Returninvoice"| $controllermenu=="Invoicebank"){echo 'show';} ?>"
            	...
            	<nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPages">
                    ...
                    <a class="nav-link p-0 px-3 py-1 text-dark" href="<?php echo base_url().'Returninvoice'; ?>">Return Invoice</a>
            ...
            <?php //} if(menucheck($menuprivilegearray, 27)==1 | menucheck($menuprivilegearray, 30)==1 | menucheck($menuprivilegearray, 31)==1){ ?>
            <!-- <a class="nav-link p-0 px-3 py-2 collapsed text-dark" href="javascript:void(0);" data-toggle="collapse" data-target="#collapseProduction" aria-expanded="false" aria-controls="collapseProduction">
                <div class="nav-link-icon"><i class="fas fa-truck-loading"></i></div>
                Production
                <div class="sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
            </a>
            <div class="collapse <?php //if($controllermenu=="Production" | $controllermenu=="Prodcutionprocess" | $controllermenu=="Packfinishgood"){echo 'show';} ?>" id="collapseProduction" data-parent="#accordionSidenav">
                <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPages">
                    <?php //if(menucheck($menuprivilegearray, 27)==1){ ?>
                    <a class="nav-link p-0 px-3 py-1 text-dark" href="<?php // echo base_url().'Production'; ?>">Approve & Start</a>
                    <?php //} if(menucheck($menuprivilegearray, 30)==1){ ?>
                    <a class="nav-link p-0 px-3 py-1 text-dark" href="<?php // echo base_url().'Prodcutionprocess'; ?>">Production Process</a>
                    <?php //} if(menucheck($menuprivilegearray, 31)==1){ ?>
                    <a class="nav-link p-0 px-3 py-1 text-dark" href="<?php // echo base_url().'Packfinishgood'; ?>">Packing & FG</a>
                    <?php //} ?>
                </nav>
            </div> -->
