...
<div class="modal fade" id="addCostModal" data-backdrop="static" data-keyboard="false" tabindex="-1"
	...
	<div class="modal-dialog modal-dialog-centered modal-xl">
		<div class="modal-content">
			<div class="modal-header">
				<h2 class="modal-title" id="staticBackdropLabel">GRNID000<label id="grnid"></label></h2>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
	...
	<div class="modal-dialog modal-dialog-centered modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body" id="GRNView">
                <h4 class="text-right">UN/GRN-0000<label id="grncode"></label></h4>
                <div id="viewhtml"></div>
			</div>
    			...
    			},
    			{
    				...
    				"render": function (data, type, full) {
    					...
    					if (full['qualitycheck'] == 0) {
    						button += '<a href="#addcostsection"><button class="btn btn-primary btn-sm btnAddCosting mr-1" id="' + full['idtbl_grn'] + '"><i class="fas fa-plus"></i></button></a>';
    					} else {
    						button += '';
    					}
    					button += '<button title="View Cost List" class="btn btn-warning btn-sm btnviewcost mr-1" id="' + full['idtbl_grn'] + '"><i class="fas fa-list"></i></button>';
