	...
	<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="form-row text-right">
					<div class="col mt-3">
						<button type="button" class="btn btn-primary btn-sm mb-3 px-3" id="btnEditinfo"><i
		...
		"columns": [{
			...
			},
			{
				...
				"render": function (data, type, full) {
					var button = '';
                    button+='<button class="btn btn-primary btn-sm btncheck mr-1" id="'+full['idtbl_semi_production']+'"><i class="fas fa-tasks"></i></button>';
