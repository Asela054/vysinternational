				...
				<div class="card">
					...
					<div class="row">
                            <div class="col-12 text-right">
                                <button type="button" class="btn btn-secondary btn-sm" data-toggle="modal" data-target="#newdirectinvoice" <?php if($addcheck==0){echo 'disabled';} ?>><i class="fas fa-plus mr-2"></i>Create New Direct Invoice</button>
                                <hr>
                            </div>
                        </div>
						<div class="row">
...
<!-- Modal -->
<div class="modal fade" id="newdirectinvoice" data-backdrop="static" data-keyboard="false" tabindex="-1"
	aria-labelledby="staticBackdropLabel" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered modal-xl">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="staticBackdropLabel">Create New  Direct Invoice</h5>
			...
			<div class="row">
				<div class="col-12">
					<div class="scrollbar pb-3" id="style-2">
						<table class="table table-bordered table-striped table-sm nowrap" style="width:100%" id="pordertablenoninvoice">
							<thead>
								<th>#</th>
								<th>Order Date</th>
								<th>Customer</th>
			...
			<br>
			<hr>
			<div id="billingsection2" style="display: none">
				<div class="row">
					<div class="col-12 col-md-4">
						<div class="row">
							<div class="col-12 col-md-12">
						...
						<div class="row">
							<div class="col-12 col-md-12">
								<div class="form-group mb-1">
									<input type="hidden" name="orderid2" class="form-control form-control-sm" id="orderid2"
										required>
									<label class="small font-weight-bold text-dark">Customer :</label>
									<input type="text" name="customer2" class="form-control form-control-sm" id="customer2"
										readonly>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-12 col-md-12">
								<div class="form-group mb-1">
									<label class="small font-weight-bold text-dark">Location :</label>
									<select class="form-control form-control-sm" name="location2" id="location2">
										<option value="">Select</option>
										<?php foreach($location->result() as $rowlocationlist){ ?>
										<option value="<?php echo $rowlocationlist->idtbl_location ?>">
											<?php echo $rowlocationlist->location ?></option>
						...
						<form>
							<div class="row">
								<div class="col-12 col-md-6">
									<label class="small font-weight-bold text-dark">Product*</label><br>
									<select class="form-control form-control-sm" style="width: 100%;" name="productlist2"
										id="productlist2" required>
									</select>
								</div>
								<div class="col-12 col-md-6">
									<div class="form-group mb-1">
										<label class="small font-weight-bold text-dark">Sale Price :</label>
										<input type="text" name="saleprice2" class="form-control form-control-sm" id="saleprice2"
											readonly>
										<input type="hidden" name="productname2" class="form-control form-control-sm"
											id="productname2">
										<input type="hidden" name="productid2" class="form-control form-control-sm"
											id="productid2">
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-12 col-md-6">
									<div class="form-group mb-1">
										<label class="small font-weight-bold text-dark">Order QTY :</label>
										<input type="number" name="orderqty2" class="form-control form-control-sm" id="orderqty2"
											readonly>
									</div>
								</div>
								<div class="col-12 col-md-6">
									<div class="form-group mb-1">
										<label class="small font-weight-bold text-dark">QTY :</label>
										<input type="number" name="qty2" id="qty2" class="form-control form-control-sm">
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-12 col-md-6">
									<div class="form-group mb-1">
										<label class="small font-weight-bold text-dark">Sale Discount
											:</label>
										<input type="number" name="salediscount2" class="form-control form-control-sm"
											id="salediscount2" value="0">
									</div>
								</div>
							</div>
							<div class="form-group mt-2">
								<button type="button" name="BtnAdd2" id="BtnAdd2" class="btn btn-primary btn-m  fa-pull-right"><i
										class="fas fa-plus"></i>&nbsp;Add</button>
							</div>
							<button type="reset" name="hiddenreset2" id="hiddenreset2" style="display:none;"></button>
						</form>
						<br><br><br>
					</div>
					...
					<div class="col-12 col-md-8">
						<div class="row">
							<div class="col-12 col-md-12">
								<div class="table scrollbar" id="style-2">
									<table class="table table-bordered table-striped  nowrap display" id="tblinvoice2">
										<thead>
											<th>Product Name</th>
											<th>Qty</th>
											<th>Sale Price</th>
										...
										<tfoot>
											<tr>
												<th class="text-right" colspan="5"><label id="labeltotal2"></label><br>
													<input type="hidden" id="hiddenfulltotal2" name="hiddenfulltotal2">
													<input type="hidden" id="hiddenfulldistotal2" name="hiddenfulldistotal2">
													<input type="hidden" id="hiddenfullnettotal2" name="hiddenfullnettotal2">
													<label id="labeldistotal2"></label><br>
													<label id="labelnettotal2"></label><br>
													<label id="htmlbillamount2"></label></th>
						...
						<br><br>
						<div class="form-group mt-2">
							<button type="button" name="Btnsubmit2" id="Btnsubmit2" class="btn btn-primary btn-m  fa-pull-right"><i
									class="far fa-save"></i>&nbsp;Save</button>
						</div>
					</div>
				</div>
...
<script>
    ...
    $(document).ready(function () {
		...
		$('#pordertablenoninvoice').DataTable({
			"destroy": true,
			"processing": true,
			"serverSide": true,
			responsive: true,
			...
			ajax: {
				url: "<?php echo base_url() ?>scripts/porderlistnoninvoice.php",
				type: "POST", // you can use GET
				// data: function(d) {}
			},
			"order": [
			...
			"columns": [{
				...
				},
				{
					...
					"render": function (data, type, full) {
						var button = '';
						button += '<button class="btn btn-primary btn-sm btnInvoice2 mr-1" id="' + full[ 'idtbl_customer_porder'] + '"><i class="fas fa-file-invoice-dollar"></i>';
