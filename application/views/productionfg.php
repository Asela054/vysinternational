				...
				<div class="container-fluid">
					<div class="page-header-content py-3">
						<h1 class="page-header-title font-weight-light">
							...
							<span>Finish Good Transaction</span>
						</h1>
					</div>
				</div>
			</div>
...
function checkLocations() {
  ...
  document.getElementById("tolocation").addEventListener("change", checkLocations);
    ...
    $(document).ready(function() {
		...
		$("#productlist").select2({
		ajax: {
			url: "<?php echo base_url() ?>Productionfg/Getproductlisttoselectpicker",
			type: "post",
			dataType: 'json',
			delay: 250,
        ...
        $('#fromlocation').on('change', function () {
        	...
        	$.ajax({
        		...
        		url: '<?php echo base_url("Productionfg/Getproductlist"); ?>',
...
$('#productlist').on('change', function () {
    ...
    $.ajax({
        ...
        url: '<?php echo base_url("Productionfg/Getbatchlist"); ?>',
        success: function (result) {
            var obj = JSON.parse(result);
            var options = '';
    ...
    $('#qty').val('');
        ...
        $(document).on("click", "#Btnsubmit", function () {
        	...
        	$.ajax({
        		...
        		url: "<?php echo base_url() ?>Productionfg/Stocktransferprocess",
        		success: function (result) {
        			// console.log(result);
