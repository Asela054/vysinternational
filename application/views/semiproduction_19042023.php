...
<!-- Modal Batch No List -->
<div class="modal fade" id="modalbatchno" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
	aria-hidden="true">
...
$(document).ready(function () {
			...
			},
			{
				...
				"render": function (data, type, full) {
					...
					if (full['grnstatus'] == 1) {
						...
						button += '<a href="<?php echo base_url() ?>Semiproduction/Semiproductiontransfer/' + full['idtbl_semi_production'] + '" onclick="return transfer_confirm()" target="_self" class="btn btn-primary btn-sm mr-1 ';
						if (statuscheck != 1) {
							button += 'd-none';
						}
	...
	$('#tablecostlist').on('click', 'tr', function () {
