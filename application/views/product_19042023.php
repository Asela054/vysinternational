                        	...
                        	<div class="col-4">
                        		<form action="<?php echo base_url() ?>Product/Productinsertupdate" method="post"
                        			...
                        			<div class="form-row mb-1">
                        				...
                        				<div class="col-6">
                        					<label class="small font-weight-bold">Semi Product</label>
                        					<div>
                        						<label class="toggle">
                        							<input class="toggle-checkbox" type="checkbox" name="semiproduct"
                        						id="semiproduct" value="1">
                        							<div class="toggle-switch"></div>
                        						</label>
                        					</div>
                        					<label class="small font-weight-bold d-none">Wholesale Price</label>
                        					<input type="text" class="form-control form-control-sm d-none" name="wholesaleprice"
                        						id="wholesaleprice">
                        				</div>
                        			</div>
			...
			<div class="modal-body">
                <div class="row">
                    <div class="col-12 mb-3">
                        <a href="<?php echo site_url('csv/samplefinishgoodinfo.csv') ?>" download>Click here</a> to download a Sample Csv
                    </div>
                </div>
                <form action="<?php echo base_url() ?>Product/Finishgoodlupload" method="post" enctype="multipart/form-data">
            ...
            "columns": [
                ...
                },
                {
                    ...
                    "render": function(data, type, full) {
                        var button='';
                        // button += '';
                        button+='<button class="btn btn-primary btn-sm btnEdit mr-1 ';if(editcheck!=1){button+='d-none';}button+='" id="'+full['idtbl_product']+'"><i class="fas fa-pen"></i></button>';
                        if(full['status']==1){
                            button+='<a href="<?php echo base_url() ?>Product/Productstatus/'+full['idtbl_product']+'/2" onclick="return deactive_confirm()" target="_self" class="btn btn-success btn-sm mr-1 ';if(statuscheck!=1){button+='d-none';}button+='"><i class="fas fa-check"></i></a>';
                        }else{
                            button+='<a href="<?php echo base_url() ?>Product/Productstatus/'+full['idtbl_product']+'/1" onclick="return active_confirm()" target="_self" class="btn btn-warning btn-sm mr-1 ';if(statuscheck!=1){button+='d-none';}button+='"><i class="fas fa-times"></i></a>';
                        }
                        button+='<a href="<?php echo base_url() ?>Product/Productstatus/'+full['idtbl_product']+'/3" onclick="return delete_confirm()" target="_self" class="btn btn-danger btn-sm ';if(deletecheck!=1){button+='d-none';}button+='"><i class="fas fa-trash-alt"></i></a>';
