                ...
                <div class="container-fluid">
                    <div class="page-header-content py-3">
                        <h1 class="page-header-title font-weight-light">
                            ...
                            <span>Stock Summery Report</span>
                        </h1>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-2">
                                <div class="form-group mb-1">
                                    ...
                                    <select type="text" class="form-control form-control-sm" name="finishgood" id="finishgood" required>
...
<script>
    $(document).ready(function () {
        ...
        $("#finishgood").select2({
            ...
            ajax: {
                url: "<?php echo base_url() ?>Rptstocksummery/Getfinishgoodlist",
                type: "post",
                dataType: 'json',
                delay: 250,
        ...
        $('#finishgood').change(function () {
        	...
        	$.ajax({
        		...
        		url: '<?php echo base_url() ?>Rptstocksummery/Getbatchnolist',
        		success: function (result) { //alert(result);
        			var obj = JSON.parse(result);
                    var html = '';
                    html += '<option value="">Select</option>';
                    $.each(obj, function (i, item) {
                        html += '<option value="' + obj[i].fgbatchno + '">';
                        html += obj[i].fgbatchno;
                        html += '</option>';
                    });
        ...
        $('#batchno').change(function () {
        	...
        	$.ajax({
        		...
        		url: '<?php echo base_url() ?>Rptstocksummery/Getsummeryreport',
        		success: function (result) { //alert(result);
