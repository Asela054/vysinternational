		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="table" id="style-2">
					<table class="table table-borderless" id="tblrowmat">
						<h5>RAW MATERIAL</h5>
						<thead class="border-bottom">
							<th class="text-right">#</th>
							<th class="text-right">Costing Type</th>
							<th class="text-right">Amount</th>
						</thead>
						<tbody id="Rawmatcost"></tbody>
						<tfoot>
							<tr>
								<th class="text-right" colspan="3">
									<label id="labelrawcosttotal"></label><br>
								</th>
							</tr>
						</tfoot>
					</table>
					<table class="table table-borderless" id="tblpacknprocess">
						<h5>PROCESSING & PACKAGING</h5>
						<thead class="border-bottom">
							<th class="text-right">#</th>
							<th class="text-right">Costing Type</th>
							<th class="text-right">Amount</th>
						</thead>
						<tbody id="packnprocess"></tbody>
						<tfoot>
							<tr>
								<th class="text-right" colspan="4">
									<label id="labelprocesscosttotal"></label><br>
								</th>
							</tr>
						</tfoot>
					</table>
					<table class="table table-borderless" id="tblshipping">
						<h5>SHIPPING</h5>
						<thead class="border-bottom">
							<th class="text-right">#</th>
							<th class="text-right">Costing Type</th>
						...
						<tbody class="border-none" id="shipping"></tbody>
						<tfoot>
							<tr>
								<th class="text-right" colspan="4">
									<label id="labelshippingcosttotal"></label><br>
								</th>
							</tr>
						</tfoot>
					</table>
            ...
            "columns": [
                ...
                },
                {
                    ...
                    "render": function(data, type, full) {
                        ...
                        button+='<a href="<?php echo base_url() ?>Salesordercost/printreport/'+full['idtbl_customer_porder']+'" target="_self" class="btn btn-dark btn-sm"><i class="fas fa-eye"></i></a>';
