						...
						<form id="createorderform2" autocomplete="off">
							...
							<div class="form-row mb-1">
								<div class="col">
									...
									<select class="form-control form-control-sm" style="width: 100%;" name="product2"
										...
										<option value="">Select</option>
										<?php foreach($prodcutlist->result() as $rowprodcutlist){ ?>
										<option value="<?php echo $rowprodcutlist->idtbl_product ?>">
											<?php echo $rowprodcutlist->materialname.' - '.$rowprodcutlist->productcode ?>
										</option>
										<?php } ?>
									</select>
								</div>
							...
							<div class="form-row mb-1">
								...
								<div class="col">
									...
									<input type="text" id="unitprice2" name="unitprice2"
										class="form-control form-control-sm d-none" value="0">
