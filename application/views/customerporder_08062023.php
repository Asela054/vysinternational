                        ...
                        <form id="createorderform" autocomplete="off">
                            ...
                            <div class="col">
                                    ...
                                    <div class="input-group mb-3">
												<input type="number" class="form-control form-control-sm col-8" name="profitmargin"
													id="profitmargin" value="20">
												<input type="text" value="%" class="form-control form-control-sm col-4" readonly>
											</div>
                                </div>
                                <div class="col">
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4">
                        <form id="createorderform2" autocomplete="off">
                            <div class="form-group mb-1">
                                <label class="small font-weight-bold text-dark">Sales Order Type*</label>
                                <input type="hidden" class="form-control form-control-sm" name="hiddenporderid" id="hiddenporderid" required>
                            ...
                            <div class="form-row mb-1">
                                <div class="col">
                                    <label class="small font-weight-bold text-dark">Order Date*</label>
                                    <input type="date" class="form-control form-control-sm" placeholder="" name="orderdate2" id="orderdate2" value="<?php echo date('Y-m-d') ?>" required>
                                </div>
                                <div class="col">
                                    <label class="small font-weight-bold text-dark">Due Date*</label>
                                    <input type="date" class="form-control form-control-sm" placeholder="" name="duedate2" id="duedate2" value="<?php echo date('Y-m-d') ?>" required>
                                </div>
                            </div>
                            <div class="form-row mb-1">                                
                                <div class="col">
                                    <label class="small font-weight-bold text-dark">Sale Type*</label>
                                    <select class="form-control form-control-sm" name="saletype2" id="saletype2" required>
                                        <option value="">Select</option>
                                        <option value="1">Local</option>
                                        <option value="2">Export</option>
                                    </select>
                                ...
                                <div class="col">
                                    <label class="small font-weight-bold text-dark">Customer*</label>
                                    <select class="form-control form-control-sm" name="customer2" id="customer2" required>
                                        <option value="">Select</option>
                                        <?php foreach($customerlist->result() as $rowcustomerlist){ ?>
                                        <option value="<?php echo $rowcustomerlist->idtbl_customer ?>"><?php echo $rowcustomerlist->name ?></option>
                                        <?php } ?>
                            ...
                            <div class="form-row mb-1">
                                <div class="col">
                                    <label class="small font-weight-bold text-dark">Product*</label><br>
                                    <select class="form-control form-control-sm" style="width: 100%;" name="product2" id="product2" required>
                                        <option value="">Select</option>
                                        <?php foreach($prodcutlist->result() as $rowprodcutlist){ ?>
                                        <option value="<?php echo $rowprodcutlist->idtbl_product ?>"><?php echo $rowprodcutlist->materialname.' - '.$rowprodcutlist->productcode ?></option>
                                        <?php } ?>
                            ...
                            <div class="col">
                                    <label class="small font-weight-bold text-dark">Profit Margin*</label>
                                    <div class="input-group mb-3">
												<input type="number" class="form-control form-control-sm col-8" name="profitmargin2"
													id="profitmargin2" value="20">
												<input type="text" value="%" class="form-control form-control-sm col-4" readonly>
											</div>
                                </div>
                                <div class="col">
                                    <label class="small font-weight-bold text-dark">Qty*</label>
                                    <input type="text" id="newqty2" name="newqty2" class="form-control form-control-sm" required>
                                </div>
                                <div class="col">
                                    <label class="small font-weight-bold text-dark d-none">Material Unit Cost</label>
                                    <input type="text" id="unitprice2" name="unitprice2" class="form-control form-control-sm d-none" value="0">
                            ...
                            <div class="form-group mt-3 text-right">
                                <button type="button" id="formsubmit2" class="btn btn-primary btn-sm px-4" <?php if($addcheck==0){echo 'disabled';} ?>><i class="fas fa-plus"></i>&nbsp;Add to list</button>
