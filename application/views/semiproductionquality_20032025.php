                ...
                <div class="container-fluid">
                    <div class="page-header-content py-3">
                        <h1 class="page-header-title font-weight-light">
                            ...
                            <span>Semi Production Quality</span>
                        </h1>
                    </div>
                </div>
            </div>
...
<script>
         $(document).on("click", ".btnViewqualityinfo", function () {
            ...
            $.ajax({
                ...
                url: '<?php echo base_url() ?>Semiproductionquality/Getqualityviewdescription',
...
$(document).ready(function () {
	...
	$('#dataTable').DataTable({
		...
		"columns": [	
			...
			},
			{
				...
				"render": function (data, type, full) {
					var button = '';
                    button+='<button class="btn btn-primary btn-sm btncheck mr-1" id="'+full['idtbl_semi_production']+'" <?php if($addcheck==0){echo 'disabled';} ?>><i class="fas fa-tasks"></i></button>';
	...
	$('#dataTable tbody').on('click', '.btnview', function () {
		...
		$.ajax({
			...
			url: '<?php echo base_url() ?>Semiproductionquality/Semiproductiondetails',
			success: function (result) { //alert(result);
	...
	$('#dataTable tbody').on('click', '.btncheck', function () {
		...
		$.ajax({
			...
			url: '<?php echo base_url() ?>Semiproductionquality/Productionpackqualityform',
			success: function (result) { //alert(result);
        ...
        $(document).on('click', '#btnEditinfo', function () {
        	...
        	$.ajax({
        		...
        		url: '<?php echo base_url() ?>Semiproductionquality/Editproductionqualityinfo',
        		success: function (result) { //alert(result);
        ...
        $('#btnsavequality').click(function(){
            ...
            $.ajax({
                url: '<?php echo base_url() ?>Semiproductionquality/Newproductioninqualitysertupdate',
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
        ...
        $('#btnapplyquality').click(function(){
            ...
            $.ajax({
                url: '<?php echo base_url() ?>Semiproductionquality/Productionpackqualityinsertupdate',
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
