      ...
      <div class="card">
        ...
        <div class="row">
        	<div class="col-12 col-md-12">
        		<table class=" mt-4 table-sm table table-bordered table-striped  nowrap display" id="porderdetailview">
        			<thead>
        				<th>#</th>
        				<th>Order Date</th>
        				<th>Customer</th>
        	...
        	<div class="row">
        		<div class="col-12 col-md-4">
        			...
        			<div class="row">
        				<div class="col-12 col-md-12">
        					<div class="form-group mb-1">
                            <input type="hidden" name="orderid" class="form-control form-control-sm" id="orderid"
        							required>
        						<label class="small font-weight-bold text-dark">Customer :</label>
        						<input type="text" name="customer" class="form-control form-control-sm" id="customer"
        							readonly>
        					</div>
        				</div>
        			</div>
        				...
        				<div class="row">
        					...
        					<div class="col-12 col-md-6">
        						<div class="form-group mb-1">
        							...
        							<input type="text" name="saleprice" class="form-control form-control-sm"
        								id="saleprice" readonly>
        							<input type="hidden" name="productname" class="form-control form-control-sm"
        								id="productname">
        							<input type="hidden" name="productid" class="form-control form-control-sm"
        								id="productid">
        						</div>
        					</div>
        				</div>
        				<div class="row">
        					...
        					<div class="col-12 col-md-6">
        						<div class="form-group mb-1">
        							...
        							<input type="number" name="salediscount" class="form-control form-control-sm"
        								id="salediscount">
        						</div>
        					</div>
        				</div>
        		...
        		<div class="col-12 col-md-8">
        				...
        				<div class="col-12 col-md-12">
        					<div class="table scrollbar" id="style-2">
        						<table class="table table-bordered table-striped  nowrap display" id="tblinvoice">
        							...
        							<tfoot>
        								<tr>
        									<th class="text-right" colspan="5"><label id="labeltotal"></label><br>
        			...
        			<div class="form-group mt-2">
        				<button type="button" name="Btnsubmit" id="Btnsubmit"
        					class="btn btn-primary btn-m  fa-pull-right"><i class="far fa-save"></i>&nbsp;Save</button>
        			</div>
        		</div>
        	</div>
...
<div class="modal fade bd-example-modal-sm" id="saletypemodel" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <button type="button" id="retailbutton" class="btn btn-primary btn-lg btn-block fa-pull-center"><i class="fas fa-cash-register fa-2x"></i>&nbsp; RETAIL SALE</button><br><br>
      <button type="button" id="wholesalebutton" class="btn btn-danger btn-lg btn-block  fa-pull-center"><i class="fas fa-cash-register fa-2x"></i>&nbsp; WHOLE SALE</button>  
    </div>
    </div>
  </div>
</div>
