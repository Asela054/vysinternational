                        ...
                        <form id="createorderform" autocomplete="off">
							...
							<div class="form-row mb-1">
								<div class="col">
									...
									<input type="text" name="returnqty" id="returnqty"
...
<!-- Modal -->
<div class="modal fade" id="viewInvoicelist" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true"  data-backdrop="static">
  <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
    <div class="modal-content">
      <div class="modal-header">
                    ...
                    },
                    {
                        ...
                        "render": function(data, type, full) {
                            var button = '';
                                ...
                                button+='<button class="btn btn-danger btn-sm btnprintReturn mr-1 ';if(editcheck!=1){button+='d-none';}button+='" id="'+full['idtbl_invoice']+'"><i class="fas fa-file-alt"></i></button>';
                            return button;
                        }
                    }
