			...
			"columns": [{
				...
				},
				{
					...
					"render": function (data, type, full) {
						...
						if (full['status'] == 1) {
							button += '<a href="<?php echo base_url() ?>Productionorderview/Productionorderstatus/' + full['idtbl_production_orderdetail'] + '/2" onclick="return deactive_confirm()" target="_self" class="btn btn-success btn-sm mr-1 ';
							if (statuscheck != 1) {
								button += 'd-none';
							}
							button += '"><i class="fas fa-check"></i></a>';
						} else {
							button += '<a href="<?php echo base_url() ?>Productionorderview/Productionorderstatus/' + full['idtbl_production_orderdetail'] + '/1" onclick="return active_confirm()" target="_self" class="btn btn-warning btn-sm mr-1 ';
							if (statuscheck != 1) {
								button += 'd-none';
							}
