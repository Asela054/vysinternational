		...
		'.$htmlcusdetail.'
    		...
    		<div class="row">
                ...
                <tr style="text-align: center; font-weight: bold; font-size: 25px;">
                    ...
                    <th style="font-size: 15px; font-weight: bold; border: 1px solid black; text-align: center;  width: 70%;">Item Code</th>
                    <th style="font-size: 15px; font-weight: bold; border: 1px solid black; text-align: center;">Unit Weight</th>
                    <th style="font-size: 15px; font-weight: bold; border: 1px solid black; text-align: center;">Order Quantity</th>
