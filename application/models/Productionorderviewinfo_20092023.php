...
class Productionorderviewinfo extends CI_Model{
    ...
    public function Getqtyinfoaccoproductiondetail(){
        ...
        $sql="SELECT `qty` FROM `tbl_production_orderdetail` WHERE `idtbl_production_orderdetail`=?";
    ...
    public function Issuematerialforproduction(){
        ...
        foreach($tableData as $rowmaterial){
            ...
            $data = array(
                ...
                'tbl_production_order_idtbl_production_order'=> $respondproductiondetail->row(0)->tbl_production_order_idtbl_production_order, 
                'tbl_product_idtbl_product'=> $respondproductiondetail->row(0)->tbl_product_idtbl_product, 
    ...
    public function Getprodcutioninfo(){
        ...
        $this->db->where('tbl_production_orderdetail.idtbl_production_orderdetail', $orderfinishgood);
        ...
        foreach($respond->result() as $rowmaterialbomlist){
            ...
            $html.='
                <tr class="pointer">
                    ...
                    <td>'.$rowmaterialbomlist->tbl_material_info_idtbl_material_info.'</td>
