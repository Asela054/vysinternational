...
class Productionorderviewreportinfo extends CI_Model{
    ...
    <body>
		...
		<h1><b>Production Order Details</b></h1>
		<div class="">
			<b>Date -</b> '.$prodate.' <br>
		</div>
		<table class="invoice-table">
			<thead>
				<tr>
					...
					<th style="text-align: center;" scope="col">Production Order Code</th>
					<th style="text-align: center;" scope="col">Production Order Date</th>
                    <th style="text-align: center;" scope="col">Production Start Date</th>
                    <th style="text-align: center;" scope="col">Production End Date</th>
				</tr>
			</thead>
			<tbody>
				'.$tblproduction.'
