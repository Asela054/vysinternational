...
class Semibominfo extends CI_Model{
    ...
    public function SemiBomOtherCostInsertUpdate(){
        ...
        $recordOption=$this->input->post('recordOptionCost');
        if(!empty($this->input->post('recordIDCost'))){$recordID=$this->input->post('recordIDCost');}
        ...
        if($recordOption==1){
            ...
            $data = array(
                ...
                'tbl_expence_type_idtbl_expence_type'=>$costtype
            );
