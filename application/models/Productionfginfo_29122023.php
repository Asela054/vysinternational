...
class Productionfginfo extends CI_Model{
    ...
    public function Getbatchlist(){
        ...
        $sql="SELECT `tbl_product_stock`.`idtbl_product_stock`,`tbl_product_stock`.`fgbatchno`, SUM(`qty`) AS totalqty FROM `tbl_product_stock`  WHERE `tbl_product_stock`.`tbl_product_idtbl_product`=? AND `tbl_product_stock`.`status`=? AND `tbl_product_stock`.`tbl_location_idtbl_location`=? GROUP BY `tbl_product_stock`.`fgbatchno`";
