<?php
class Sideinfo extends CI_Model{
    ...
    public function Sideinsertupdate(){
        ...
        if($recordOption==1){
            ...
            $this->db->where('idtbl_side', $recordID);
            $this->db->update('tbl_side', $data);
    ...
    public function Sideedit(){
        ...
        $obj=new stdClass();
        $obj->id=$respond->row(0)->idtbl_side;
        $obj->sidename=$respond->row(0)->sidename;
        $obj->sidecode=$respond->row(0)->sidecode;
