                    ...
                    if(!empty($rowmaininfo->grninfo)){
                        foreach($rowmaininfo->grninfo as $rowgrninfo){
                            ...
                            <tr>
                                ...
                                <th nowrap><label class="text-dark font-weight-bold text-uppercase">Qty:</label> ' . $rowgrninfo->qty . '</th>
