...
class Invoiceviewreportposinfo extends CI_Model{
    public function printreportpos($x){
        ...
        foreach($productrespond->result() as $rowlist){
            $tblinvoice.='
            <tr>
            <td style="font-size:9px; border-bottom:1px dotted black; text-align:left;" class="text-right">'.$rowlist->productcode.' <br> '.$rowlist->barcode.' <br> '.$rowlist->desc.'</td>
            <td style="font-size:9px; border-bottom:1px dotted black; text-align:right;" class="text-right">'.$rowlist->qty.'</td>
            <td style="font-size:9px; border-bottom:1px dotted black; text-align:right;" class="text-right">'.number_format(($rowlist->saleprice), 2).'</td>
            <td style="font-size:9px; border-bottom:1px dotted black; text-align:right;" class="totalrawcost text-right">'.number_format(($rowlist->qty * $rowlist->saleprice), 2).'</td>             
        </tr>
        ...
        <div id="DivIdToPrint">
            ...
            <td style="text-align: center; font-size:16px;" colspan="2">
                <h1 class="font-weight-light" style="margin-top:0;margin-bottom:0;">
                    <span style="font-size:24px;vertical-align: top;">
                        <img src="'.base_url().'images/CH-removebg-preview.png" alt="" style="width:50%; height:230px;">
                    </span>
                </h1>
                <p style="margin-top: 5px; margin-bottom: 5px;">No-63, Jaya Mawatha, Ratmalana, 011-2635185</p>
                    ...
                    <td>
                        <table style="width:100%;">
                            ...
                            <tr>
                                ...
                                <td style="text-align: left; font-size:16px;font-weight: bold;">:</td>
                                <td
                                    style="text-align: right; font-size:16px;font-weight: bold; border-bottom:1px double black; border-top:1px solid black;">
                                    '.number_format(($nettotal), 2).'</td>
                            </tr>
                            <tr>
                                <td style="text-align: left; font-size:16px;font-weight: bold; padding-top: 25px;">Payment
                                    Method</td>
                ...
                <tr>
                    <td style="text-align: center; font-size: 12px; padding-top: 25px; padding-right: 100px" colspan="2">
                        <span style="text-align: center; font-size: 16px; font-weight: bold;">Thank You! Come again!</span>
                    </td>
                </tr>
                <tr style="margin-top:20px;">
                    <td style="text-align: center; font-size:10px; padding-top: 10px; padding-right: 100px" colspan="2"><span
                            style="font-size:16px;">Important Notice : In case of
                            returns, return the
                            bill within 7 days.</span><br></td>
                </tr>
                <tr>
                <tr>
                    <td style="text-align: center; font-size:10px; padding-top: 25px; padding-right: 100px" colspan="2"><span
                            style="font-size:16px;">CEYLON’Z HARVEST by UNISTAR INTENATIONAL PVT LTD
                            53, 3rd LANE, RATMALANA, 011-2635185 </span><br><i style="font-size:16px;"
