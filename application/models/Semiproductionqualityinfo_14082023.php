...
class Semiproductionqualityinfo extends CI_Model{
    public function Productionpackqualityform()
    {
        ...
        $sqlmaterial = "SELECT `tbl_material_info`.`materialinfocode`, `tbl_material_info`.`idtbl_material_info`, `tbl_material_code`.`materialname`
            FROM `tbl_semi_production_detail`
            LEFT JOIN `tbl_semi_production` ON `tbl_semi_production`.`idtbl_semi_production`=`tbl_semi_production_detail`.`tbl_semi_production_idtbl_semi_production` LEFT JOIN `tbl_material_info` ON `tbl_material_info`.`idtbl_material_info`=`tbl_semi_production_detail`.`tbl_material_info_idtbl_material_info`
        ...
        $html .= '
            ...
            <div class="form-row">
                <div class="col">
                    ...
                    <input type="time" name="washtime" id="washtime" class="form-control form-control-sm">
                </div>
            </div>
            <div class="form-row">
                <div class="col">
            ...
            <div class="form-row">
                <div class="col">
                    ...
                    <input type="time" name="drytime" id="drytime" class="form-control form-control-sm">
                </div>
            </div>
            <div class="form-row">
                <div class="col">
            ...
            <div class="form-row">
                <div class="col">
                    ...
                    <input type="time" name="drycoolingtime" id="drycoolingtime" class="form-control form-control-sm">
                </div>
            </div>
            <div class="form-row">
            	<div class="col">
        ...
        $html .= '
            ...
            <div class="form-row">
                ...
                <div class="col">
                    ...
                    <input type="time" name="roasting_time" id="roasting_time" class="form-control form-control-sm">
                </div>
            </div>
            <div class="form-row">
                <div class="col">
            ...
            <div class="form-row">
                <div class="col">
                    ...
                    <input type="time" name="cooling_time" id="cooling_time" class="form-control form-control-sm">
                </div>
            </div>
            <div class="form-row">
                <div class="col">
    ...
    public function Editproductionqualityinfo(){
        ...
        $html .= '
            ...
            <div class="form-row">
                <div class="col">
                    <label class="small font-weight-bold text-dark">WASHING TIME</label>
                    <input type="time" name="washtime" id="washtime" class="form-control form-control-sm" value="'.$rowupdatequalitylist->washing_time.'">
                </div>
            </div>
            <div class="form-row">
                <div class="col">
            ...
            <div class="form-row">
                <div class="col">
                    <label class="small font-weight-bold text-dark">DRYING TIME</label>
                    <input type="time" name="drytime" id="drytime" class="form-control form-control-sm" value="'.$rowupdatequalitylist->drying_time.'">
                </div>
            </div>
            <div class="form-row">
                <div class="col">
            ...
            <div class="form-row">
                <div class="col">
                    <label class="small font-weight-bold text-dark">DRYING - COOLING TIME</label>
                    <input type="time" name="drycoolingtime" id="drycoolingtime" class="form-control form-control-sm" value="'.$rowupdatequalitylist->drying_cooling_time.'">
                </div>
            </div>
            <div class="form-row">
            	<div class="col">
        ...
        $html .= '
            ...
            <div class="form-row">
                ...
                <div class="col">
                    <label class="small font-weight-bold text-dark">ROASTING TIME</label>
                    <input type="time" name="roasting_time" id="roasting_time" class="form-control form-control-sm" value="'.$rowupdatequalitylist->roasting_time.'">
                </div>
            </div>
            <div class="form-row">
                <div class="col">
            ...
            <div class="form-row">
                <div class="col">
                    <label class="small font-weight-bold text-dark">COOLING TIME</label>
                    <input type="time" name="cooling_time" id="cooling_time" class="form-control form-control-sm" value="'.$rowupdatequalitylist->cooling_time.'">
                </div>
            </div>
            <div class="form-row">
                <div class="col">
