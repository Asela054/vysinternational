...
class Productinfo extends CI_Model{
    ...
    public function Barcode($tackingno){
        $html = '<html><body style="text-align: center"><barcode code="'.$tackingno.'" type="C128C" height="1.4" /><br>'.$tackingno.'</body></html>';
    ...
    public function Createlabel($fgcode, $socode, $mfdate, $expdate, $batchno){
        ...
        <html>
            <body>
                <table>
                    <tr>
                        <td width="5%" text-rotate="90" style="padding-right: 10px;"><h1>FG LABEL</h1></td>
                        <td>
                            <table>
                                <tr>
                                    <td width="25%">FG Code</td>
                                    <td width="5%">:</td>
                                    <td>'.$fgcode.'</td>
                                </tr>
                                <tr>
                                    <td width="25%">SO No</td>
                                    <td width="5%">:</td>
                                    <td>'.$socode.'</td>
                                </tr>
                                <tr>
                                    <td width="25%">MF Date</td>
                                    <td width="5%">:</td>
                                    <td>'.$mfdate.'</td>
                                </tr>
                                <tr>
