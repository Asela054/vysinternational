...
<body>
	<div id="DivIdToPrint">
		<img src="'.base_url().'images/CH-removebg-preview.png" alt=""
			style="width:30%; height:70px; margin-left:250px;">
		<table style="width:100%;">
			<tr>
				<td style="text-align: center; font-size:16px;border-bottom:1px dotted black;" colspan="2">
					<h2 class="font-weight-light" style="margin-top:0;margin-bottom:0;"><span
							style="font-size:14px;vertical-align: top;"></span>Unistar International (PVT)Ltd</h2>
					No-63, Jaya Mawatha, Ratmalana,<br>
					Tel: 011-2635185
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td style="text-align: right; font-size:16px;font-weight: bold;">'.number_format(($grosstotal), 2).'
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td style="text-align: right; font-size:16px;font-weight: bold;">'.number_format(($nettotal), 2).'</td>
			</tr>
			<tr>
				<td style="text-align: left; font-size:16px;font-weight: bold;">Payment Method</td>
				<td style="text-align: right; font-size:16px;font-weight: bold;">Cash</td>
			</tr>
			<tr>
			...
			<tr>
				<td style="text-align: center; font-size:10px;" colspan="2"><span
						style="text-align: center; font-size:16px;font-weight: bold;">Thank You. Come again
						!</span><br><i style="text-align: center; font-size:16px;" class="lab la-facebook"></i></td>
			</tr>
			<tr>
				<td style="text-align: center; font-size:10px;" colspan="2"><span
						style="text-align: center; font-size:16px;font-weight: bold;">CEYLON’Z HARVEST by UNISTAR
