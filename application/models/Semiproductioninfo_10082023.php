...
class Semiproductioninfo extends CI_Model{
    ...
    public function Semiproductiontransfer(){
        ...
        $this->db->where('tbl_semi_production_detail.tbl_semi_production_idtbl_semi_production', $semiproductionID);
    ...
    public function Checkproductorderqty(){
        ...
        $this->db->select('`qty`, `tbl_semi_production_idtbl_semi_production`, `tbl_material_info_idtbl_material_info`');
        $this->db->from('tbl_semi_production_detail');
