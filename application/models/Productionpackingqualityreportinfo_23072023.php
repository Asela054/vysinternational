...
$html = '
    ...
    <body>
		...
		<tr>
			...
			<td style="font-size:10px; border-bottom: 1px solid; padding-right:10px; width: 37%; padding-top:10px;"></td>
			<td style="font-size:10px; padding-left:20px; padding-top:10px; width: 30%;">SALES ORDER NO :</td>
	...
	<table style="width:100%; border-collapse: collapse;">
		<tr>
			<td
				style="border-left: 1px solid black; font-size:10px; padding-left: 20px; padding-top:15px; width: 50%;">
				PACKING START DATE :
			</td>
			<td style="font-size:10px; border-bottom: 1px solid; padding-right:-20px; width: 50%; padding-top:15px;"></td>
			<td style="font-size:10px; padding-left:30px;  padding-top:15px; width: 65%;">PACKING END DATE :
			</td>
			<td style="font-size:10px; border-bottom: 1px solid; width: 60%; padding-top:15px;"></td>
	...
	<table style="width:100%; border-collapse: collapse;">
		<tr>
			...
			<td style="font-size:10px; border-bottom: 1px solid; width: 80%;">'.$updaterespond->row(0)->productcode.'</td>
			...
			<table style="width: 100%; border-collapse: collapse;">
				...
				<tr>
					...
					<td
						style="font-size:8.5px; text-align:center; border-left: 1px solid black; border-top: 1px solid black; border-bottom: 1px solid black; width: 60%;">
						'.$rowrawmateriallist->materialinfocode.'
					</td>
					<td
						style="font-size:8.5px; border-bottom: 1px solid black; border-right: 1px solid black; width: 0%; text-align: right;">
					</td>
					<td
						style="font-size:8.5px; text-align:center; border-left: 1px solid black; solid black; border-top: 1px solid black; border-bottom: 1px solid black; width: 2%;">
			...
			$html.='
				<tr>
					...
					<td
						style="font-size:8.5px; text-align:center; border-left: 1px solid black; solid black; border-top: 1px solid black; border-bottom: 1px solid black; width: 10%;"><img src="'.base_url().'images/check.png" class="img-fluid" alt=""
			...
			$html.='
				<tr>
					...
					<td
						style="font-size:10px; font-size:8.5px; text-align:center; border-left: 1px solid black; border-top: 1px solid black; border-bottom: 1px solid black; width: 60%;">'.$updaterespond->row(0)->moisture.'
					</td>
					<td style="font-size:8.5px; border-bottom: 1px solid black; width: 40%; text-align: right;"></td>
					<td
				...
				<tr>
					...
					<td
						style="font-size:10px; font-size:8.5px; text-align:center; border-left: 1px solid black; border-top: 1px solid black; border-bottom: 1px solid black; width: 60%;">'.$updaterespond->row(0)->color.'
					</td>
					<td style="font-size:8.5px; border-bottom: 1px solid black; width: 40%; text-align: right;"></td>
					<td
						style="font-size:8.5px; text-align:center; solid black; border-top: 1px solid black; border-bottom: 1px solid black; width: 60%;">
				...
				<tr>
					...
					<td
						style="font-size:10px; font-size:8.5px; text-align:center; border-left: 1px solid black; border-top: 1px solid black; border-bottom: 1px solid black; width: 60%;">'.$updaterespond->row(0)->taste.'
					</td>
					<td style="font-size:8.5px; border-bottom: 1px solid black; width: 40%; text-align: right;"></td>
					<td
						style="font-size:8.5px; text-align:center; solid black; border-top: 1px solid black; border-bottom: 1px solid black; width: 60%;">
			...
			<table style="width: 100%; border-collapse: collapse;">
				<tr>
					<td style="border-left: 1px solid black; border-bottom: 1px solid black; width:5%"></td>
					<td
						...
						<table style="border-collapse: collapse; border: 1px solid black;">
							<tr>
								<td style="border: 1px solid black;  background-color:#A2A2A0; color:#000;">
									STATUS
								</td>
							</tr>
							<tr>
					...
					<td
						style="font-size:10px; border-right: 1px solid black; border-top: 1px solid black; border-bottom: 1px solid black; width: 50%;">
