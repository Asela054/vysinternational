...
class Qualitycheckreportinfo extends CI_Model {
    public function Qualitycheckreport($x, $y) {
        ...
        $respond = $this->db->query($sql, array($recordID, 1));        $qualities = $respond->result();
        ...
        foreach($qualities as $rowlist){
            if($j==26){
                ...
                if($i==0){
                    ...
                    $qualityhtml.='<td style="border: thin solid #000;">'.$rowlist->qualitysubcategory.'</td><td style="border: thin solid #000;">'.$rowlist->descstatus.'</td><td style="border: thin solid #000;">PASS</td><tr>';
                    $i++;
                }
                else if($i==2){
                    $qualityhtml.='<tr><td style="border: thin solid #000;">'.$rowlist->qualitysubcategory.'</td><td style="border: thin solid #000;" colspan="3">'.$rowlist->descstatus.'</td><td style="border: thin solid #000;">FAIL</td></tr>';
