...
class Supplierbankinfo extends CI_Model{
	...
	public function Supplierbankinsertupdate(){
        ...
        if($recordOption==1){
            ...
            $this->db->insert('tbl_supllier_bank_details', $data);
            ...
            $this->db->where('idtbl_supllier_bank_details', $recordID);
            $this->db->update('tbl_supllier_bank_details', $data);
	...
	public function Supplierbankedit(){
        ...
        $this->db->select('*');
        $this->db->from('tbl_supllier_bank_details');
        $this->db->where('idtbl_supllier_bank_details', $recordID);
        ...
        $obj=new stdClass();
        $obj->id=$respond->row(0)->idtbl_supllier_bank_details;
