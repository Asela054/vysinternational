...
class Customerporderinfo extends CI_Model{
    ...
    public function Porderinsertupdate(){
        ...
        public function Customerporderedit()
        {
            ...
            $this->db->from('tbl_customer_porder');
            $this->db->join('tbl_customer_porder_detail', 'tbl_customer_porder_detail.idtbl_customer_porder_detail = tbl_customer_porder_detail.tbl_customer_porder_idtbl_customer_porder', 'left');
