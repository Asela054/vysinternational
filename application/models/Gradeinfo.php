<?php
class Gradeinfo extends CI_Model{
    ...
    public function Gradeinsertupdate(){
        ...
        if($recordOption==1){
            ...
            $this->db->where('idtbl_grade', $recordID);
    ...
    public function Gradeedit(){
        ...
        $obj=new stdClass();
        $obj->id=$respond->row(0)->idtbl_grade;
        $obj->gradename=$respond->row(0)->gradename;
        $obj->gradecode=$respond->row(0)->gradecode;
