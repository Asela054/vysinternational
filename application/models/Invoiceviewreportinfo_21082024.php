...
class Invoiceviewreportinfo extends CI_Model{
    ...
    <body>
    	<div class="container">
    		...
    		<div class="address">
    			...
    			<table>
    				<tr>
    					...
    					<td>
    						53, 3rd Lane, Ratmalana, Sri Lanka
    					</td>
    				</tr>
    				<tr>
    					<th>
    				...
    				<tr>
    					...
    					<td>
    						admin@unistar-international.com
    					</td>
    				</tr>
    			</table>
    		</div>
    		<div class="address2">
    			...
    			<table>
    				...
    				<tr>
    					...
    					<td>
    						www.admin@unistar-international.com
    					</td>
    				</tr>
    			</table>
    		</div>
    		...
    		<h3 style="margin-bottom:80px;">Amount in Words: <span>'.$amountInWords.'</span></h3>
    		<table style="width:100%;">
    			<tr>
    				<th>Prepared By :</th>
    				<td>........................................</td>
    		...
    		<hr>
    		<h3 style="margin-bottom:5px; margin-top:30px;"><u>BANK DETAILS FOR PAYMENT</u></h3>
    			...
    			<div>
    				<table style="width: 100%; border-collapse: collapse;">
    					...
    					<tr>
    						...
    						<td style="text-align: left;">-</td>
    						<td style="text-align: left;">'.$accnum.'</td>
    					</tr>
    					<tr>
    					...
    					<tr>
    						...
    						<th style="text-align: left;">Branch Cd.</th>
    						<td style="text-align: left;">-</td>
    						<td style="text-align: left;">'.$branchcode.'</td>
    						<th style="text-align: left;">Bank Cd.</th>
    						<td style="text-align: left;">-</td>
    						<td style="text-align: left;">'.$bankcode.'</td>
							<td><img src="images/unistarimg.jpeg" alt="Unistar Image" style="width: 290%; max-width: 170px; height: auto;"></td>
    					</tr>
    				</table>
    			</div>
    		</div>
