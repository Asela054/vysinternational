			...
			<body>
				...
				<header>
					<table width="100%" style="border-collapse: collapse;">
						<tr>
							<td width="20%" style="vertical-align: top;border-bottom: thin 1px solid; padding-bottom: 5px;"><img src="images/Ch.jpg" style="width: 150px;height: 100px;margin-top: 25px;"></td>
							<td width="40%" style="vertical-align: top;border-bottom: thin 1px solid; padding-bottom: 5px; padding-left: 20px;">
								<h6 style="margin-bottom: 0px;"><u>HEAD OFFICE</u></h6>
    							<h5 style="margin-top: 0px;margin-bottom: 0px;">Unistar International Pvt Ltd</h5>
							...
							<td width="40%" style="vertical-align: top;border-bottom: thin 1px solid; padding-bottom: 5px;">
								<h6 style="margin-bottom: 0px;"><u>SHOWROOM</u></h6>
    							<h5 style="margin-top: 0px;margin-bottom: 0px;">Ceylon`z Harvest</h5>
								<table style="font-size: 12px;">
									<tr>
										<th>Address</th>
										<td>-</td>
					...
					<table width="100%" style="border-collapse: collapse;">
						<tr>
							...
							<td width="20%" style="vertical-align: top; border-top: thin 1px solid; border-bottom: thin 1px solid;">
								<img src="images/invoicelogo.png" alt="Unistar Image" width="180px" style="margin-top: 25px;">
							</td>
						</tr>
					</table>
				</footer>
						...
						<tr>
							<td colspan="2">
								<table width="100%" style="border-collapse: collapse;margin-top:10px;font-size:14px;">
									<thead>
										<tr>
											<th style="text-align: center; width:5%; border: thin 1px solid;" scope="col">#</th>
											...
											<th style="text-align: center; width:13%; border: thin 1px solid;" scope="col">ORDER QUANTITY</th>
									...
									<tfoot>
										<tr>
											<th style="border: thin 1px solid;padding:5px;" colspan="4">TOTAL</th>
										...
										<tr>
											<th style="border: thin 1px solid;padding:5px;" colspan="5">VAT</th>
											<th style="text-align: right; color: #000;border: thin 1px solid;padding:5px;"><label>0.00</label></th>
										</tr>
										<tr>
											<th style="border: thin 1px solid;padding:5px;" colspan="5">TOTAL FOR THE INVOICE</th>
											<th style="text-align: right; color: #000;border: thin 1px solid;padding:5px;"><label>'.number_format($total, 2).'</label></th>
										</tr>
									</tfoot>
								</table>
