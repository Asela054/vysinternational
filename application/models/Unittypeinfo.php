<?php
class Unittypeinfo extends CI_Model{
    ...
    public function Unittypeinsertupdate(){
        ...
        if($recordOption==1){
            ...
            $this->db->insert('tbl_unit_type', $data);
            ...
            $this->db->where('idtbl_unit_type', $recordID);
            $this->db->update('tbl_unit_type', $data);
    ...
    public function Unittypeedit(){
        ...
        $obj=new stdClass();
        $obj->id=$respond->row(0)->idtbl_unit_type;
        $obj->unittypename=$respond->row(0)->unittypename;
        $obj->unittypecode=$respond->row(0)->unittypecode;
