<?php
class Forminfo extends CI_Model{
    ...
    public function Forminsertupdate(){
        ...
        if($recordOption==1){
            ...
            $this->db->where('idtbl_form', $recordID);
    ...
    public function Formedit(){
        ...
        $obj=new stdClass();
        $obj->id=$respond->row(0)->idtbl_form;
        $obj->formname=$respond->row(0)->formname;
        $obj->formcode=$respond->row(0)->formcode;
