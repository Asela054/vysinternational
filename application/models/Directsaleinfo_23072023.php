    ...
    public function Getproductlist(){
        ...
        if($respond->num_rows() > 0){ 
            foreach($respond->result() as $rowlist){
                ...
                $sqlstockcheck="SELECT SUM(`qty`) AS sumqty FROM `tbl_product_stock` WHERE `tbl_product_idtbl_product`='$productID' AND `tbl_location_idtbl_location`='$locationType'"; 
                ...
                $html.='
                    ...
                    <tr tabindex="0" class=';if($stockcount==0){$html.='table-danger';}else{$html.='pointer';}$html.=' id="'.$rowlist->idtbl_product.'">
