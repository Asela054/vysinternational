...
class Semiproductionqualityreportinfo extends CI_Model{
    public function Semiproductionqualitycheckreport($x, $y){
		...
		$sqlmachineallocation = "SELECT `machine`, `startdatetime`, `enddatetime`  FROM `tbl_machine_allocation` LEFT JOIN `tbl_machine` ON `tbl_machine`.`idtbl_machine` = `tbl_machine_allocation`.`tbl_machine_idtbl_machine` WHERE `tbl_machine_allocation`.`tbl_semi_production_idtbl_semi_production` = ?";
		...
		$sqlqty="SELECT `qty` FROM `tbl_semi_production_detail` LEFT JOIN `tbl_semi_production` ON `tbl_semi_production`.`idtbl_semi_production`=`tbl_semi_production_detail`.`tbl_semi_production_idtbl_semi_production` WHERE `tbl_semi_production_detail`.`tbl_semi_production_idtbl_semi_production`=? AND `tbl_semi_production_detail`.`tbl_material_info_idtbl_material_info`=?";
    ...
    <body>
    	...
    	<div class="container">
    		<table style="width:100%; padding-top:0px; border-collapse: collapse;">
    			<tr>
    				<td
    					style="border-left: 1px solid black; font-size:10px; padding-left:20px; padding-top:10px; width: 32%;">
    					PRODUCTION ORDER NO :
    				</td>
    				<td style="font-size:10px; border-bottom: 1px solid; padding-right:10px; width: 30%; padding-top:10px;">'.$recordID.'</td>
    				<td style="font-size:10px; padding-left:20px; padding-top:10px; width: 25%;">SALES ORDER NO :</td>
    		...
    		<table style="width:100%; border-collapse: collapse;">
    			<tr>
    				<td
    					style="border-left: 1px solid black; font-size:10px; padding-left: 20px; padding-top:15px; width: 40%;">
    					PRODUCTION START DATE :
    				</td>
    				<td style="font-size:10px; border-bottom: 1px solid; padding-right:-20px; width: 30%; padding-top:15px;">'.$respondmachineallocation->row(0)->startdatetime.'</td>
    				<td style="font-size:10px; padding-left:30px;  padding-top:15px; width: 40%;">PRODUCTION END DATE :
    				</td>
    				<td style="font-size:10px; border-bottom: 1px solid; width: 40%; padding-top:15px;">'.$respondmachineallocation->row(0)->enddatetime.'</td>
    				<td style="border-right: 1px solid black; width: 9%"></td>
    			</tr>
    		</table>
    		<table style="width:100%; border-collapse: collapse;">
    			<tr>
    				<td
    					style="border-left: 1px solid black; font-size:10px; padding-left: 20px;  padding-top:15px; width: 15%;">
    					ITEM CODE :
    				</td>
    				<td style="font-size:10px; border-bottom: 1px solid; width: 80%;">'.$respond->row(0)->materialinfocode.'</td>
			...
			';
				...
				<table style="width:100%; border-collapse: collapse;">
					<tr>
						<td style="border-left: 1px solid black; font-size:10px; padding-left: 20px; padding-top:15px; padding-bottom:15px; width: 40%;">
							BOM - BILL OF MATERIALS :
						</td>
						<td style="font-size:10px; width: 75%; padding-top:15px; padding-bottom:15px;">' . $rowbomlist->materialinfocode . '</td>
    		...
    		<div class="form-row">
    			...
    			<table style="width: 100%; border-collapse: collapse;">
    				<tr>
    					<td
    						style="font-size:8.5px; border-bottom: 1px solid black; border-left: 1px solid black; width: 41%; text-align: right;">
    						ORDER QUANTITY :</td>
    					<td
    					...
    					<td
    						style="font-size:8.5px; border-bottom: 1px solid black; border-right: 1px solid black; width: 39%; text-align: right;">
    			...
    			<table style="width: 100%; border-collapse: collapse;">
    				<tr>
    					...
    					<td
    						style="font-size:8.5px; border-bottom: 1px solid black; border-right: 1px solid black; width: 40%; text-align: right;">
    						WASHING TIME :</td>
    					<td
    				...
    				<tr>
    					<td style="border-left: 1px solid black; width: 2%;"></td>
    					<td style="font-size:8.5px; border-bottom: 1px solid black; border-left: 1px solid black; width: 40%; text-align: right;">
    						CUT SIZE :</td>
    					<td
    						style="font-size:10px; text-align:center; border-left: 1px solid black; border-right: 1px solid black; border-top: 1px solid black; border-bottom: 1px solid black; width: 60%;">
					...
					<tr>
    					<td style="border-left: 1px solid black; width: 2%;"></td>
    					<td
    						style="font-size:8.5px; border-left: 1px solid black; width: 40%; text-align: right;">MACHINES :
    						</td>
    					<td
    						style="font-size:8.5px; text-align:center; border-left: 1px solid black; border-right: 1px solid black; border-top: 1px solid black; border-bottom: 1px solid black; width: 60%;">
							MACHINE
    					</td>
    					<td
    						style="font-size:8.5px; border-bottom: 1px solid black; border-right: 1px solid black; width: 40%; text-align: right;">
    						MESH SIZE</td>
    					<td
    						style="font-size:8.5px; text-align:center; border-left: 1px solid black; solid black; border-top: 1px solid black; border-bottom: 1px solid black; width: 60%;">
							WASTAGE
    					</td>
    					<td
    						style="text-align:center; border-right: 1px solid black; border-top: 1px solid black; border-bottom: 1px solid black; width: 20%;">
                ...
                $html.='
    					...
    					<td style="border-left: 1px solid black; width: 2%;"></td>
    					<td
    						style="font-size:8.5px; border-bottom: 1px solid black; border-left: 1px solid black; width: 40%; text-align: right;">MOISTURE % (AFTER GRINDING) :
    						</td>
    					<td
    						style="font-size:10px; font-size:8.5px; text-align:center; border-left: 1px solid black; border-top: 1px solid black; border-bottom: 1px solid black; width: 60%;">' . $respond->row(0)->moisture_after_grinding . '
    					</td>
    					<td
    						style="font-size:8.5px; border-bottom: 1px solid black; width: 40%; text-align: right;"></td>
    					<td
    						style="font-size:8.5px; text-align:center; solid black; border-top: 1px solid black; border-bottom: 1px solid black; width: 60%;">
    					</td>
    					<td
    						style="text-align:center; border-right: 1px solid black; border-top: 1px solid black; border-bottom: 1px solid black; width: 20%;">
					...
					<tr>
    					...
    					<td
    						style="font-size:8.5px; text-align:center; border-left: 1px solid black; border-right: 1px solid black; border-top: 1px solid black; border-bottom: 1px solid black; width: 20%;">
    						ROASTING TIME :
					...
					<tr>
    					...
    					<td
    						style="font-size:8.5px; border-bottom: 1px solid black; border-right: 1px solid black; width: 40%; text-align: center;">
    						NO</td>
    					<td
    						style="font-size:10px; text-align:center; border-left: 1px solid black; solid black; border-top: 1px solid black; border-bottom: 1px solid black; width: 60%;">
    			...
    			<table style="width: 100%; border-collapse: collapse;">
    				<tr>
    					<td
    						style="font-size:10px; border-top: 1px solid black; border-left: 1px solid black; border-bottom: 1px solid black; width: 25%; padding-left:73px">
    						COMMENTS :
    					</td>
						<td
						style="font-size:10px; border-right: 1px solid black; border-top: 1px solid black; border-bottom: 1px solid black; width: 75%;">
