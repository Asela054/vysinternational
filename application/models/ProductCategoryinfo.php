<?php
class ProductCategoryinfo extends CI_Model{
    public function ProductCategoryinsertupdate(){
        ...
        if($recordOption==1){
            ...
            $this->db->where('idtbl_product_category', $recordID);
    ...
    public function ProductCategoryedit(){
        ...
        $obj=new stdClass();
        $obj->id=$respond->row(0)->idtbl_product_category;
        $obj->name=$respond->row(0)->productcategory;
        $obj->code=$respond->row(0)->categorycode;
