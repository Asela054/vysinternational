...
class Machineinfo extends CI_Model{
    ...
    public function Machineinsertupdate(){
        ...
        $factorylist=$this->input->post('factorylist');
        ...
        if($recordOption==1){
            ...
            foreach ($factorylist as $value) {
            $this->db->insert('tbl_factory_has_tbl_machine', array('tbl_machine_idtbl_machine'=> $insert_id, 'tbl_factory_idtbl_factory'=> $value));
            }
    ...
    public function Machineedit(){
        ...
        $obj->name=$respond->row(0)->machine;
        $obj->code=$respond->row(0)->machinecode;
