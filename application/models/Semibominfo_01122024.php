...
class Semibominfo extends CI_Model{
    ...
    public function SemiBomOtherCostInsertUpdate(){
        ...
        $this->db->where('tbl_semi_bom_idtbl_semi_bom', $hidebomid);
        $this->db->delete('tbl_semi_bom_has_tbl_semi_bom_other_cost');

        foreach($tabledata as $rowtabledata){
            $data = array(
                'tbl_semi_bom_idtbl_semi_bom'=>$hidebomid, 
                'tbl_semi_bom_other_cost_idtbl_semi_bom_other_cost'=>$rowtabledata->othercostid, 
            );

            $this->db->insert('tbl_semi_bom_has_tbl_semi_bom_other_cost', $data);
        }            
