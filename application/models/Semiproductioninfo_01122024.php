...
class Semiproductioninfo extends CI_Model{
    ...
    public function Semiproductioninsertupdate(){
        ...
        $this->db->join('tbl_semi_bom_has_tbl_semi_bom_other_cost', 'tbl_semi_bom_has_tbl_semi_bom_other_cost.tbl_semi_bom_other_cost_idtbl_semi_bom_other_cost = tbl_semi_bom_other_cost.idtbl_semi_bom_other_cost', 'left');
        $this->db->where('tbl_semi_bom_has_tbl_semi_bom_other_cost.tbl_semi_bom_idtbl_semi_bom', $semibomlist);
    ...
    public function Semiproductionapprove($x){
        ...
        $this->db->select('tbl_material_info_idtbl_material_info, tbl_semi_bom_info_idtbl_semi_bom_info');
        $this->db->from('tbl_semi_production');
        ...
        $this->db->select('batchnolist, tbl_material_info_idtbl_material_info, qty');
        $this->db->from('tbl_semi_production_detail');
    ...
    public function Getsemiprodcutioninfo(){
        ...
        $this->db->select('`tbl_semi_production`.`idtbl_semi_production`, `tbl_semi_production`.`prodate`, `tbl_semi_production`.`qty`, `tbl_semi_production`.`tbl_material_info_idtbl_material_info`, `tbl_material_info`.`materialinfocode`, `tbl_material_code`.`materialname`, `tbl_unit`.`unitcode`');
        $this->db->from('tbl_semi_production');
