...
class Salesordercostinfo extends CI_Model{
    ...
    public function Getsalesoredrproduct(){
        ...
        foreach($respond->result() as $rowlist){
            ...
            <tr>
                ...
                <td><button type="button" value="'.$rowlist->idtbl_product.'" id="'.$rowlist->idtbl_customer_porder_detail.'" name="'.$rowlist->idtbl_customer_porder.'" class="btnAddcost btn btn-primary btn-sm float-center" data-toggle="modal" data-target="#exampleModal"><i class="fas fa-plus"></i></button></td>
    ...
    public function Costinsertupdate(){
        ...
        // }else{
        //     $perunitcostamount=$totalcost/$qty;
        //     $amount=$perunitcostamount+$unitprice;
        // }
        ...
        foreach($tableData as $rowtabledata){
            ...
            $this->db->select('netsaleprice AS netprice');
            ...
            $updatenetprice = $previousnetprice + $netsaleprice;
            
            $this->db->where('tbl_customer_porder_idtbl_customer_porder', $orderid);
            $this->db->where('tbl_product_idtbl_product', $productid);
            $this->db->update('tbl_customer_porder_detail', array('netsaleprice' => $updatenetprice));
