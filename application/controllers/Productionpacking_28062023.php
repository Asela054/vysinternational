...
class Productionpacking extends CI_Controller {
    ...
    public function Createlabel($dailycomID){
		...
		$pdf->SetFont('Arial','',5);
		$pdf->TextWithDirection(8,7,'FG Code : '.$respond->row(0)->productcode,'R');
		$pdf->TextWithDirection(8,11,'SO No     : UN/SOD-0000'.$respond->row(0)->tbl_customer_porder_idtbl_customer_porder,'R');
